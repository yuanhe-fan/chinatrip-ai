...
export function ShareView({
  ...
  return (
    <main className="app-min-viewport bg-[#F8F5EF] bg-[linear-gradient(135deg,#F8F5EF_0%,#EEF4F6_52%,#F7F0E6_100%)] text-[#172033]">
      <header className="app-safe-top-compact sticky top-0 z-30 border-b border-[#E6D8C7] bg-white/76 px-4 pb-3 shadow-[0_8px_30px_rgba(20,36,58,0.04)] backdrop-blur-xl sm:px-7 sm:py-3">
      ...
      <div className="app-safe-bottom-roomy mx-auto flex w-full max-w-[60rem] flex-col gap-8 px-4 pt-8 sm:px-7 sm:py-12">
